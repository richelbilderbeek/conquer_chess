...
option_video_and_audio_view::option_video_and_audio_view()
  : m_selected{options_video_and_audio_view_item::game_speed}
{
...
void option_video_and_audio_view::decrease_selected()
{
  switch (m_selected)
  {
    case options_video_and_audio_view_item::game_speed: decrease_game_speed(m_game_options); break;
    case options_video_and_audio_view_item::music_volume: decrease_music_volume(m_game_options); break;
    case options_video_and_audio_view_item::sound_effects_volume: decrease_sound_effects_volume(m_game_options); break;
    case options_video_and_audio_view_item::starting_position: decrease_starting_position(m_game_options); break;
    case options_video_and_audio_view_item::left_controls:
    {
...
void option_video_and_audio_view::increase_selected()
{
  switch (m_selected)
  {
    case options_video_and_audio_view_item::game_speed: increase_game_speed(m_game_options); break;
    case options_video_and_audio_view_item::music_volume: increase_music_volume(m_game_options); break;
    case options_video_and_audio_view_item::sound_effects_volume: increase_sound_effects_volume(m_game_options); break;
    case options_video_and_audio_view_item::starting_position: increase_starting_position(m_game_options); break;
    case options_video_and_audio_view_item::left_controls:
    {
      set_next_state(program_state::left_controls);
    }
...
bool option_video_and_audio_view::process_event_impl(sf::Event& event)
{
  ...
  else if (event.type == sf::Event::KeyPressed)
  {
    ...
    else if (key_pressed == sf::Keyboard::Key::Right)
    {
      switch (m_selected)
      {
        case options_video_and_audio_view_item::game_speed:
        default:
        assert(m_selected == options_video_and_audio_view_item::game_speed);
        case options_video_and_audio_view_item::music_volume:
        case options_video_and_audio_view_item::sound_effects_volume:
        case options_video_and_audio_view_item::starting_position:
          increase_selected();
        break;
        case options_video_and_audio_view_item::left_controls:
        case options_video_and_audio_view_item::right_controls:
  ...
  else if (event.type == sf::Event::MouseMoved)
  {
    ...
    if (is_in(mouse_screen_pos, m_layout.get_chess_board().get_board())) set_selected(options_video_and_audio_view_item::starting_position);
    else if (is_in(mouse_screen_pos, m_layout.get_game_speed_value())) set_selected(options_video_and_audio_view_item::game_speed);
    else if (is_in(mouse_screen_pos, m_layout.get_controller_type_value(side::lhs))) set_selected(options_video_and_audio_view_item::left_controls);
    else if (is_in(mouse_screen_pos, m_layout.get_music_volume_value())) set_selected(options_video_and_audio_view_item::music_volume);
    else if (is_in(mouse_screen_pos, m_layout.get_controller_type_value(side::rhs))) set_selected(options_video_and_audio_view_item::right_controls);
    else if (is_in(mouse_screen_pos, m_layout.get_sound_effects_volume_value())) set_selected(options_video_and_audio_view_item::sound_effects_volume);
    else if (is_in(mouse_screen_pos, m_layout.get_starting_pos_value())) set_selected(options_video_and_audio_view_item::starting_position);
  }
...
void option_video_and_audio_view::process_resize_event_impl(sf::Event& event)
{
  ...
  m_layout = options_video_and_audio_view_layout(
    w,
...
void option_video_and_audio_view::set_selected(const options_video_and_audio_view_item i)
{
  if (m_selected != i)
  {
    game_resources::get().get_sound_effects().play_hide();
...
void option_video_and_audio_view::draw_impl()
{
  ...
  m_controls_bar.set_draw_left_right_increase_descrease(
       m_selected == options_video_and_audio_view_item::game_speed
    || m_selected == options_video_and_audio_view_item::music_volume
    || m_selected == options_video_and_audio_view_item::sound_effects_volume
    || m_selected == options_video_and_audio_view_item::starting_position
  );
  m_controls_bar.set_draw_select(
       m_selected == options_video_and_audio_view_item::left_controls
    || m_selected == options_video_and_audio_view_item::right_controls
  );
  m_controls_bar.draw();
...
void option_video_and_audio_view::start_impl()
{
  assert(!is_active());
  set_is_active(true);
}

void option_video_and_audio_view::stop_impl()
{
  assert(is_active());
  clear_next_state();
  set_is_active(false);
...
void option_video_and_audio_view::tick_impl(const delta_t)
{
  assert(is_active());
  // Nothing here yet
}
