...
options_laws_view_layout::options_laws_view_layout(
  const screen_rect& r,
...
const screen_rect& options_laws_view_layout::get_controller_type_value(const side player_side) const noexcept
{
...
const screen_rect& options_laws_view_layout::get_selectable_rect(const options_laws_view_item item) const noexcept
{
  switch (item)
  {
    ...
    case options_laws_view_item::left_controls: return m_left_controls_value;
    default:
...
void test_options_laws_view_layout()
{
  ...
  // get_selectable_rect
  {
    ...
    assert(layout.get_selectable_rect(options_laws_view_item::left_controls) == layout.get_controller_type_value(side::lhs));
    assert(layout.get_selectable_rect(options_laws_view_item::right_controls) == layout.get_controller_type_value(side::rhs));
  }
