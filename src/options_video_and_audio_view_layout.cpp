...
options_video_and_audio_view_layout::options_video_and_audio_view_layout(
  const screen_rect& r,
...
const screen_rect& options_video_and_audio_view_layout::get_controller_type_value(const side player_side) const noexcept
{
...
const screen_rect& options_video_and_audio_view_layout::get_selectable_rect(const options_video_and_audio_view_item item) const noexcept
{
  switch (item)
  {
    case options_video_and_audio_view_item::game_speed: return m_game_speed_value;
    case options_video_and_audio_view_item::music_volume: return m_music_volume_value;
    case options_video_and_audio_view_item::sound_effects_volume: return m_sound_effects_volume_value;
    case options_video_and_audio_view_item::starting_position: return m_starting_pos_value;
    case options_video_and_audio_view_item::left_controls: return m_left_controls_value;
    default:
...
std::vector<screen_rect> get_panels(const options_video_and_audio_view_layout& layout)
{
  return
  {
...
void test_options_video_and_audio_view_layout()
{
  #ifndef NDEBUG
  // get_panels
  {
    const options_video_and_audio_view_layout layout;
    assert(!get_panels(layout).empty());
  }
  // get_selectable_rect
  {
    const options_video_and_audio_view_layout layout;
    assert(layout.get_selectable_rect(options_video_and_audio_view_item::game_speed) == layout.get_game_speed_value());
    assert(layout.get_selectable_rect(options_video_and_audio_view_item::music_volume) == layout.get_music_volume_value());
    assert(layout.get_selectable_rect(options_video_and_audio_view_item::sound_effects_volume) == layout.get_sound_effects_volume_value());
    assert(layout.get_selectable_rect(options_video_and_audio_view_item::starting_position) == layout.get_starting_pos_value());
    assert(layout.get_selectable_rect(options_video_and_audio_view_item::left_controls) == layout.get_controller_type_value(side::lhs));
    assert(layout.get_selectable_rect(options_video_and_audio_view_item::right_controls) == layout.get_controller_type_value(side::rhs));
  }
