#include "options_controls_view.h"
...
options_controls_view::options_controls_view()
  : m_selected{options_controls_view_item::game_speed}
{
...
void options_controls_view::decrease_selected()
{
  switch (m_selected)
  {
    case options_controls_view_item::game_speed: decrease_game_speed(m_game_options); break;
    case options_controls_view_item::music_volume: decrease_music_volume(m_game_options); break;
    case options_controls_view_item::sound_effects_volume: decrease_sound_effects_volume(m_game_options); break;
    case options_controls_view_item::starting_position: decrease_starting_position(m_game_options); break;
    case options_controls_view_item::left_controls:
    {
...
void options_controls_view::increase_selected()
{
  switch (m_selected)
  {
    case options_controls_view_item::game_speed: increase_game_speed(m_game_options); break;
    case options_controls_view_item::music_volume: increase_music_volume(m_game_options); break;
    case options_controls_view_item::sound_effects_volume: increase_sound_effects_volume(m_game_options); break;
    case options_controls_view_item::starting_position: increase_starting_position(m_game_options); break;
    case options_controls_view_item::left_controls:
    {
      set_next_state(program_state::left_controls);
    }
...
bool options_controls_view::process_event_impl(sf::Event& event)
{
  ...
  else if (event.type == sf::Event::KeyPressed)
  {
    ...
    else if (key_pressed == sf::Keyboard::Key::Right)
    {
      switch (m_selected)
      {
        case options_controls_view_item::game_speed:
        default:
        assert(m_selected == options_controls_view_item::game_speed);
        case options_controls_view_item::music_volume:
        case options_controls_view_item::sound_effects_volume:
        case options_controls_view_item::starting_position:
          increase_selected();
        break;
        case options_controls_view_item::left_controls:
        case options_controls_view_item::right_controls:
  ...
  else if (event.type == sf::Event::MouseMoved)
  {
    ...
    if (is_in(mouse_screen_pos, m_layout.get_chess_board().get_board())) set_selected(options_controls_view_item::starting_position);
    else if (is_in(mouse_screen_pos, m_layout.get_game_speed_value())) set_selected(options_controls_view_item::game_speed);
    else if (is_in(mouse_screen_pos, m_layout.get_controller_type_value(side::lhs))) set_selected(options_controls_view_item::left_controls);
    else if (is_in(mouse_screen_pos, m_layout.get_music_volume_value())) set_selected(options_controls_view_item::music_volume);
    else if (is_in(mouse_screen_pos, m_layout.get_controller_type_value(side::rhs))) set_selected(options_controls_view_item::right_controls);
    else if (is_in(mouse_screen_pos, m_layout.get_sound_effects_volume_value())) set_selected(options_controls_view_item::sound_effects_volume);
    else if (is_in(mouse_screen_pos, m_layout.get_starting_pos_value())) set_selected(options_controls_view_item::starting_position);
  }
...
void options_controls_view::process_resize_event_impl(sf::Event& event)
{
  ...
  m_layout = options_controls_view_layout(
    w,
...
void options_controls_view::set_selected(const options_controls_view_item i)
{
  if (m_selected != i)
  {
    game_resources::get().get_sound_effects().play_hide();
...
void options_controls_view::draw_impl()
{
  ...
  m_controls_bar.set_draw_left_right_increase_descrease(
       m_selected == options_controls_view_item::game_speed
    || m_selected == options_controls_view_item::music_volume
    || m_selected == options_controls_view_item::sound_effects_volume
    || m_selected == options_controls_view_item::starting_position
  );
  m_controls_bar.set_draw_select(
       m_selected == options_controls_view_item::left_controls
    || m_selected == options_controls_view_item::right_controls
  );
  m_controls_bar.draw();
...
void draw_bottom(options_controls_view& v)
{
...
void draw_bottom_header(options_controls_view& v)
{
...
void draw_bottom_row(options_controls_view& v, const side player_side)
{
  const auto& layout{v.get_layout()};
...
void draw_game_speed(options_controls_view& v)
{
  const auto& layout = v.get_layout();
...
void draw_pieces(options_controls_view& view)
{
  game_controller c(
...
void draw_starting_position(options_controls_view& v)
{
  const auto& layout = v.get_layout();
...
void draw_top(options_controls_view& v)
{
...
void draw_layout_panels(options_controls_view& v)
{
...
void draw_music_volume(options_controls_view& v)
{
  const auto& layout = v.get_layout();
...
void draw_selected_panel(options_controls_view& v)
{
  draw_outline(v.get_layout().get_selectable_rect(v.get_selected()));
}

void draw_sound_effects_volume(options_controls_view& v)
{
  const auto& layout = v.get_layout();
...
void options_controls_view::start_impl()
{
  assert(!is_active());
  set_is_active(true);
}

void options_controls_view::stop_impl()
{
  assert(is_active());
  clear_next_state();
  set_is_active(false);
...
void options_controls_view::tick_impl(const delta_t)
{
  assert(is_active());
  // Nothing here yet
}
