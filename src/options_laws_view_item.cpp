...
{
  const auto a{magic_enum::enum_values<options_laws_view_item>()};
  std::vector<options_laws_view_item> v;
  v.reserve(a.size());
...
options_laws_view_item get_above(const options_laws_view_item item) noexcept
{
  ...
  switch (item)
  {
    ...
    case options_laws_view_item::right_controls:
      ...
      return options_laws_view_item::left_controls;
  }
}
...
options_laws_view_item get_below(const options_laws_view_item item) noexcept
{
  switch (item)
  {
    ...
    case options_laws_view_item::left_controls: return options_laws_view_item::right_controls;
    default:
    case options_laws_view_item::right_controls:
      assert(item == options_laws_view_item::right_controls);
...
options_laws_view_item get_left_of(const options_laws_view_item item)
 noexcept
{
  switch (item)
  {
...
options_laws_view_item get_right_of(const options_laws_view_item item)
 noexcept
{
  switch (item)
  {
...
{
#ifndef NDEBUG
  // get_all_options_laws_view_items
  {
    const auto v{get_all_options_laws_view_items()};
    assert(!v.empty());
  }
  // Game speed
  {
  ...
  // Starting position
  {
    assert(get_above(options_laws_view_item::starting_position) == options_laws_view_item::sound_effects_volume);
    assert(get_right_of(options_laws_view_item::starting_position) == options_laws_view_item::left_controls);
    assert(get_below(options_laws_view_item::starting_position) == options_laws_view_item::left_controls);
    assert(get_left_of(options_laws_view_item::starting_position) == options_laws_view_item::sound_effects_volume);
  }
  // Left controls
  {
    assert(get_above(options_laws_view_item::left_controls) == options_laws_view_item::starting_position);
    assert(get_right_of(options_laws_view_item::left_controls) == options_laws_view_item::right_controls);
    assert(get_below(options_laws_view_item::left_controls) == options_laws_view_item::right_controls);
    assert(get_left_of(options_laws_view_item::left_controls) == options_laws_view_item::starting_position);
  }
  // Right controls
  {
  ...
  // get_above
  {
    for (const auto i: get_all_options_laws_view_items())
    {
...
std::string to_str(const options_laws_view_item t) noexcept
{
