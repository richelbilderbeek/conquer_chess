...
{
  return action(action_type::press_attack, game_coordinat());
}

action create_press_down_action()
{
  return action(action_type::press_down, game_coordinat());
}

action create_press_left_action()
{
  return action(action_type::press_left, game_coordinat());
}
...
{
  return action(action_type::press_move, game_coordinat());
}

action create_press_right_action()
{
  return action(action_type::press_right, game_coordinat());
}
...
{
  return action(action_type::press_select, game_coordinat());
}

action create_press_up_action()
{
  return action(action_type::press_up, game_coordinat());
}
