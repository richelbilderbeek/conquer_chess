...
void test_game_view_layout()
{
  ...
  {
    const game_view_layout layout{screen_coordinat(1024, 576)};
    assert(layout.get_tl_board().get_x() == 0.0 + 2.0);
    assert(layout.get_tl_board().get_y() == 0.0 + 2.0);
    assert(layout.get_br_board().get_x() == 576.0 - 2.0);
    assert(layout.get_br_board().get_y() == 576.0 - 2.0);

    assert(layout.get_tl_side().get_x() == 576.0 - 2.0 + 10.0);
    assert(layout.get_tl_side().get_y() == 2.0);
    assert(layout.get_br_side().get_x() == 1024 - 2.0);
    assert(layout.get_br_side().get_y() == 576.0 - 2.0);
    const double board_width{layout.get_board_width()};
    assert(board_width == 576.0 - 4.0);
    const double board_height{layout.get_board_height()};
    assert(board_height == 576.0 - 4.0);
