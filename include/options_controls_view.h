#ifndef OPTION_CONTROLS_VIEW_H
#define OPTION_CONTROLS_VIEW_H
...
/// The Options dialog.
class options_controls_view : public view
{
public:
  explicit options_controls_view();
  ...
  options_controls_view_item get_selected() const noexcept { return m_selected; }
  ...
  void set_selected(const options_controls_view_item i);
...
private:
  ...
  options_controls_view_layout m_layout;

  /// The physical controllers to display this window
  physical_controllers m_pc;

  /// The selected item
  options_controls_view_item m_selected;
