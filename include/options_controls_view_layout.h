#ifndef OPTIONS_CONTROLS_VIEW_LAYOUT_H
#define OPTIONS_CONTROLS_VIEW_LAYOUT_H
...
class options_controls_view_layout
{
public:
  explicit options_controls_view_layout(
  ...
  const screen_rect& get_selectable_rect(const options_controls_view_item item) const noexcept;
...
/// Test the options_controls_view_layout class
void test_options_controls_view_layout();

#endif // OPTIONS_CONTROLS_VIEW_LAYOUT_H
