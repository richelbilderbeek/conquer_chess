#ifndef OPTIONS_VIDEO_AND_AUDIO_VIEW_LAYOUT_H
#define OPTIONS_VIDEO_AND_AUDIO_VIEW_LAYOUT_H
...
class options_video_and_audio_view_layout
{
public:
  explicit options_video_and_audio_view_layout(
  ...
  const screen_rect& get_selectable_rect(const options_video_and_audio_view_item item) const noexcept;
...
/// Test the options_video_and_audio_view_layout class
void test_options_video_and_audio_view_layout();

#endif // OPTIONS_VIDEO_AND_AUDIO_VIEW_LAYOUT_H
