...
std::vector<piece> get_default_starting_pieces() noexcept
{
  return {
    ...
    piece(chess_color::white, piece_type::bishop, game_coordinat(5.5, 0.5)),
    ...
    piece(chess_color::black, piece_type::bishop, game_coordinat(2.5, 0.5)),
    ...
    piece(chess_color::black, piece_type::bishop, game_coordinat(5.5, 0.5)),
